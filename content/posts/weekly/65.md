...
如果用人类语言类比，我感觉 Tree-sitter 像是兴趣广泛的语言学爱好者，知道 à、en 和 dans 是法语里的介词，但不知道是什么意思。给他一个法语句子他能划分出句子成分，但是自己不会写也读不懂。~~天哪，这简直就是我。~~ 语言服务器除了能读懂语法，还能指出用词不当和句式杂糅等问题，对一门语言有最官方和全面的了解。
...
上周更新了邮箱地址到 `hi@eltr.ac`，突然想到自己的 GPG 密钥对也应该更新，毕竟密钥上还用的是旧邮箱信息。一开始我不知道能够直接用 `gpg --edit-key` 增加 UID，所以生成了一个新的密钥对。正好，我之前的密钥一直是储存在本地的，日常使用也是直接使用主密钥签名，这并不是最佳实践，甚至可以说十分危险。
