...
3. 博客**每周**至少**三次**更新，可以通过 [RSS](/rss/) 订阅。
...
5. 除了阅读首页的新文章，也欢迎通过[分类](/categories/)和[标签](/tags/)查找你感兴趣的内容，或者按下 ⌘K（Ctrl+K）搜索文章；如果你想，也可以在[图谱页面](/graph/)通过视觉化的双向链接浏览博客。
6. 除了一般的非虚构写作文章（议叙），博客还有[书评](/library/)和[小说](/fictions/)部分的内容。
